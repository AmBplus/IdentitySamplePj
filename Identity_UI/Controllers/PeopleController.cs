...
namespace Identity_UI.Controllers
{
    ...
    public class PeopleController : Controller
    {
        ...
        public PeopleController(IdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,City,Region")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,City,Region")] Person person)
        {
            if (id != person.id)
            {
                return NotFound();
